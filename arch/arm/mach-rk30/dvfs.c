...
static struct cpufreq_frequency_table cpu_dvfs_table[] = {
	...
	// {.frequency	= 126 * DVFS_KHZ, .index	= 1000 * DVFS_MV},
...
static struct cpufreq_frequency_table dep_cpu2core_table[] = {
        // {.frequency = 126 * DVFS_KHZ, .index    = 1000 * DVFS_MV},//logic 1.100V
	...
	// {.frequency = 1608 * DVFS_KHZ,.index    = 1175 * DVFS_MV},//logic 1.175V
        // {.frequency = 1704 * DVFS_KHZ,.index    = 1175 * DVFS_MV},//logic 1.175V
        // {.frequency = 1800 * DVFS_KHZ,.index    = 1175 * DVFS_MV},//logic 1.175V
	{.frequency	= CPUFREQ_TABLE_END},
};
